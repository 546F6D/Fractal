...
{
  px = scaled x coordinate of pixel (scaled to lie in the Mandelbrot px scale (-2.5, 1))
  py = scaled y coordinate of pixel (scaled to lie in the Mandelbrot py scale (-1, 1))
  x = 0.0
  y = 0.0
  iteration = 0
  max_iteration = 1000
